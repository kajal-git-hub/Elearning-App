...
class RefundAdapter(private var refundList: List<RefundItem>):RecyclerView.Adapter<RefundAdapter.RefundViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RefundAdapter.RefundViewHolder {
    ...
    override fun onBindViewHolder(holder: RefundAdapter.RefundViewHolder, position: Int) {
